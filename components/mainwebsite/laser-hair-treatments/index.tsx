...
function mapServiceToTreatment(service: PublicService): Treatment {
  ...
  if (!descriptionText) {
    descriptionText = "US FDA-approved, painless, and safe technology";
  }
  ...
  return {
    ...
    image: service.image || "/img/assts/treatment/treatment1.png",
    link: service.slug ? `/services/${service.slug}` : undefined,
  };
}

export default async function LaserHairTreatments() {
  const response = await getPublicServices({
    ...
    sub_category: "66545d890c42d4097a3533f1",
    ...
    return (
      <div className={styles.treatmentsGrid}>
        <div className={styles.emptyState}>
          No laser hair reduction treatments found.
        </div>
      </div>
    );
  }
