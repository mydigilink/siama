...
const API_BASE =
 PUBLIC_API_BASE_URL + "/services?page=1&limit=6&sortBy=created_at&sortOrder=desc&category=665451b416a3fd61d1e6e104";
  ...
  const concernsMenuItems = [
    ...
    { label: "Gaps in Teeth", slug: "gaps-in-teeth", id: "681e3aae5ccfa5802f5207b9" },
    { label: "Crooked Teeth", slug: "crooked-teeth", id: "681e3aae5ccfa5802f5207b9" },
    { label: "Misaligned teeth", slug: "misaligned-teeth", id: "681e3aae5ccfa5802f5207b9" },
    { label: "Missing Tooth", slug: "missing-tooth", id: "681e3aae5ccfa5802f5207b9" },
    { label: "Full Mouth Rehabilitation", slug: "full-mouth-rehabilitation", id: "681f7c575ccfa5802f52d487" },
    { label: "Pain in Tooth", slug: "pain-in-tooth", id: "681e3aae5ccfa5802f5207b9" },
    { label: "Yellow Teeth", slug: "yellow-teeth", id: "681e3aae5ccfa5802f5207b9" },
...
export const CONCERNS_SUB_CATEGORIES = [
  ...
  { label: "Dental Sathi", id: "681e3aae5ccfa5802f5207b9" },
...
export default function ConcernsServicesWidget() {
  ...
  const subCategory = searchParams.get("slug");
      ...
      <div className='container'>
        <div className="row">
          <div className="col-md-12 mb-4 text-center">
            <h2 className={styles.widgetTitle}>Explore Services by Concerns</h2>
          
          </div>
          <div className="col-md-2">
            <h4 className="mb-2"><b>Types</b></h4>
            <hr />
<ul 
                  style={{ display: "flex", gap: "0.5rem", flexDirection: "column", marginTop: "1rem"   }}
                    >
                     {concernsMenuItems.map((item) => (
  <li key={item.id} style={{ display: "flex", gap: "1rem" }}>
    <Link
      style={{ display: "flex", gap: "0.5rem" }}
      href={`/concerns?slug=${item.slug}&subCategory=${item.id}`}
    ...
    >
      <input
        ...
        name="concern"
        id={item.slug}
        checked={subCategory === item.slug} // ✅ SELECT BASED ON URL
        readOnly
      />
