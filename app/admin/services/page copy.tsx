...
/>
  ...
  <div className="space-y-2">
    {(formData.benefits || []).map((b: any, idx: number) => (
      <div key={idx} className="flex gap-2">
        ...
        <input
          ...
          className="flex-1 px-3 py-2 text-sm bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-400 focus:border-amber-400 outline-none"
          placeholder="Pre-treatment Care text"
        />
        ...
        <button
          ...
          className="px-3 py-2 text-xs font-semibold text-red-600 bg-red-50 border border-red-100 rounded-lg hover:bg-red-100"
        >
          Remove
        </button>
    ...
    <button
      ...
      className="px-3 py-2 text-xs font-semibold text-amber-700 bg-amber-50 border border-amber-100 rounded-lg hover:bg-amber-100"
    >
      + Add Benefit
    </button>
  </div>
  ...
  <div className="space-y-2">
    {(formData.postTreatmentCare || []).map((c: any, idx: number) => (
      <div key={idx} className="flex gap-2">

        <input
          value={c?.tips || ''}
          onChange={(e) => {
            const updated = [...(formData.postTreatmentCare || [])];
            updated[idx] = { tips: e.target.value };

            setFormData((prev: any) => ({
              ...prev,
              postTreatmentCare: updated
            }));
          }}
          className="flex-1 px-3 py-2 text-sm border rounded-lg"
          placeholder="Care tip"
        />

        <button
          type="button"
          onClick={() => {
            const updated = (formData.postTreatmentCare || []).filter(
              (_: any, i: number) => i !== idx
            );
    ...
    <button
      ...
      onClick={() =>
        setFormData((prev: any) => ({
          ...prev,
          postTreatmentCare: [...(prev.postTreatmentCare || []), { tips: '' }]
        }))
      }
      ...
      <div key={index} className="relative group w-full h-24">
        ...
        >
          ×
                ...
                <div className="sm:col-span-2 border p-4 rounded-lg bg-gray-50 space-y-3">

  <label className="flex items-center gap-2">
    <input
  type="checkbox"
  checked={formData.areasTreatedSection?.enabled || false}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
/>
  ...
  <input
    placeholder="Women Intro"
    value={formData.areasTreatedSection.womenIntro}
    onChange={(e) =>
      setFormData({
        ...formData,
        areasTreatedSection: {
          ...formData.areasTreatedSection,
          womenIntro: e.target.value
        }
      })
    }
    className="w-full px-3 py-2 border rounded"
  />
  <label className="block text-xs font-semibold text-gray-700">
 Women Areas (comma separated)
    </label>
  <input
    placeholder="Women Areas (comma separated)"
    value={formData.areasTreatedSection.womenAreas.join(', ')}
    onChange={(e) =>
      setFormData({
        ...formData,
        areasTreatedSection: {
          ...formData.areasTreatedSection,
          womenAreas: e.target.value.split(',').map(v => v.trim())
        }
      })
    }
    className="w-full px-3 py-2 border rounded"
  ...
  {/* MEN */}
  <input
    placeholder="Men Intro"
    value={formData.areasTreatedSection.menIntro}
    onChange={(e) =>
      setFormData({
        ...formData,
        areasTreatedSection: {
          ...formData.areasTreatedSection,
          menIntro: e.target.value
        }
      })
    }
    className="w-full px-3 py-2 border rounded"
  />
<label className="block text-xs font-semibold text-gray-700">
    Men Areas (comma separated)
  </label>

  <input
    placeholder="Men Areas"
    value={formData.areasTreatedSection.menAreas.join(', ')}
    onChange={(e) =>
      setFormData({
        ...formData,
        areasTreatedSection: {
          ...formData.areasTreatedSection,
          menAreas: e.target.value.split(',').map(v => v.trim())
        }
      })
    }
    className="w-full px-3 py-2 border rounded"
...
<input
  ...
  value={formData.areasTreatedSection?.howItWorksTitle || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
<div>
<label className="block text-xs font-semibold text-gray-700">
 How It Works Paragraphs (comma separated)
  </label>
<input
  placeholder="How It Works Paragraphs (comma separated)"
  value={formData.areasTreatedSection?.howItWorksParagraphs?.join(', ') || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
        ...formData.areasTreatedSection,
        howItWorksParagraphs: e.target.value.split(',').map(v => v.trim())
      }
    })
  }
  className="w-full px-3 py-2 border rounded"
...
<input
  ...
  value={formData.areasTreatedSection?.benefitsTitle || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
<input
  ...
  value={formData.areasTreatedSection?.benefitsSubtitle || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
<input
  placeholder="Benefits List (comma separated)"
  value={formData.areasTreatedSection?.benefits?.join(', ') || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
        ...formData.areasTreatedSection,
        benefits: e.target.value.split(',').map(v => v.trim())
      }
    })
  }
  className="w-full px-3 py-2 border rounded"
...
<input
  ...
  value={formData.areasTreatedSection?.beforeTitle || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
<input
  placeholder="Before Items"
  value={formData.areasTreatedSection?.beforeItems?.join(', ') || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
        ...formData.areasTreatedSection,
        beforeItems: e.target.value.split(',').map(v => v.trim())
      }
    })
  }
  className="w-full px-3 py-2 border rounded"
...
<input
  ...
  value={formData.areasTreatedSection?.afterTitle || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
<input
  ...
  value={formData.areasTreatedSection?.afterItems?.join(', ') || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
        ...formData.areasTreatedSection,
        afterItems: e.target.value.split(',').map(v => v.trim())
      }
    })
  }
  className="w-full px-3 py-2 border rounded"
...
<input
  placeholder="Ideal Title"
  value={formData.areasTreatedSection?.idealTitle || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
<input
  placeholder="Ideal Items"
  value={formData.areasTreatedSection?.idealItems?.join(', ') || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
        ...formData.areasTreatedSection,
        idealItems: e.target.value.split(',').map(v => v.trim())
      }
    })
  }
  className="w-full px-3 py-2 border rounded"
...
<input
  placeholder="Not Ideal Title"
  value={formData.areasTreatedSection?.notIdealTitle || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
        ...formData.areasTreatedSection,
        notIdealTitle: e.target.value
      }
    })
  }
  className="w-full px-3 py-2 border rounded"
...
<input
  placeholder="Not Ideal Items"
  value={formData.areasTreatedSection?.notIdealItems?.join(', ') || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
        ...formData.areasTreatedSection,
        notIdealItems: e.target.value.split(',').map(v => v.trim())
      }
    })
  }
  className="w-full px-3 py-2 border rounded"
...
<input
  ...
  value={formData.areasTreatedSection?.ctaTitle || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
<input
  ...
  value={formData.areasTreatedSection?.ctaText || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
<input
  ...
  value={formData.areasTreatedSection?.ctaButtonText || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
...
<input
  ...
  value={formData.areasTreatedSection?.ctaButtonLink || ''}
  onChange={(e) =>
    setFormData({
      ...formData,
      areasTreatedSection: {
